...
/**
 * @extends ServiceEntityRepository<Filename>
 *
...
class FilenameRepository extends ServiceEntityRepository
{
    ...
    public function add(Filename $entity, bool $flush = false): void
    {
    ...
    public function remove(Filename $entity, bool $flush = false): void
    {
